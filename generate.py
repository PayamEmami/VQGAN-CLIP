...
vq_parser.add_argument("-rosc",  "--rotate_scale", type=float, help="Rotate degree %", default=0, dest='rotate_scale')
            ...
            if args.make_zoom_video:
                if i % args.zoom_frequency == 0:
                    ...
                    if args.zoom_start <= i:
                        ...
                        if args.rotate_scale != 0:
                            pil_image_zoom = pil_image.rotate(args.rotate_scale)
                        else:
                            pil_image_zoom = pil_image
